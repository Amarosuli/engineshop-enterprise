...
<svelte:component this={Layout} user={data.user}>
	{#if $navigating}
		<div transition:fade={{ duration: 200 }} class="inset-0 justify-center backdrop-blur-sm items-center flex gap-4 absolute z-[100] w-full h-full text-2xl font-bold">

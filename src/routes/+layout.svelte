...
<svelte:component this={Layout} user={data.user}>
	{#if $navigating}
		<div transition:fade={{ duration: 200 }} class="absolute inset-0 z-[100] flex h-full w-full items-center justify-center gap-4 text-2xl font-bold backdrop-blur-sm">

...
migrate((db) => {
  ...
  collection.options = {
    "query": "SELECT preservation_list.id, preservation_list.engine_id, preservation_list.duration, preservation_list.date_performed, preservation_list.material, (ROW_NUMBER() OVER(partition BY preservation_list.id ORDER BY preservation_list.date_performed DESC )) AS HistoryNumber FROM preservation_list"
  }
  ...
  collection.options = {
    "query": "SELECT preservation_list.id, preservation_list.engine_id, engine_list.esn, preservation_list.duration, preservation_list.date_performed, preservation_list.material  FROM preservation_list\nJOIN engine_list ON engine_list.id = preservation_list.engine_id"
  }
